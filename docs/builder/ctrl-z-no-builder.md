...
![Nome do bloco](/img/builder/ctrl-z-nome-do-bloco.gif)

### Movimentação de um ou mais blocos

![Movimentação do bloco](/img/builder/ctrl-z-movimentacoes-do-bloco.gif)
...
![Barra de conteúdo](/img/builder/ctrl-z-barra-de-conteudo.gif)
...
![Barra de condições de saída](/img/builder/ctrl-z-barra-de-condicao-de-saida.gif)
...
![Barra de ações](/img/builder/ctrl-z-barra-de-acoes.gif)
