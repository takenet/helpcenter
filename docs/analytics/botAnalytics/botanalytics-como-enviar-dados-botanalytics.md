...
![Add a new bot - BotAnalytics](/img/practice/integrations/integ-botanalytics-como-enviar-dados-botanalytics-1.png)<br>
...
![Informando BLiP como plataforma](/img/practice/integrations/integ-botanalytics-como-enviar-dados-botanalytics-2.png)<br>

e) Copie o Token de acesso do seu bot.

![Token de acesso do Bot](/img/practice/integrations/integ-botanalytics-como-enviar-dados-botanalytics-3.png)<br>

**Obs.: Você pode encontrar o Token do seu bot sempre que precisar acessando**: *Configurações > Bots > Detalhes do seu bot*

![Acessando informação de Token de acesso](/img/practice/integrations/integ-botanalytics-como-enviar-dados-botanalytics-4.png)<br>
...
![Menu integrações BLiP](/img/practice/integrations/integ-botanalytics-como-enviar-dados-botanalytics-5.png)<br>
...
![Integração com BotAnalytics](/img/practice/integrations/integ-botanalytics-como-enviar-dados-botanalytics-6.png)<br>
