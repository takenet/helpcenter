...
![Painel de administração do site](/img/practice/blip-chat/chat-adicionar-blip-chat-site-wix-1.png)<br>

Adicione o script do BLiP Chat conforme indicado no portal.

![script blip chat](/img/practice/blip-chat/chat-adicionar-blip-chat-site-wix-2.png)<br>
...
![permitir o dominio no portal do blip](/img/practice/blip-chat/chat-adicionar-blip-chat-site-wix-3.png)
...
![Inspecionando a página para encontrar domínio](/img/practice/blip-chat/chat-adicionar-blip-chat-site-wix-4.png)<br>
...
![Testando página](/img/practice/blip-chat/chat-adicionar-blip-chat-site-wix-5.png)<br>
