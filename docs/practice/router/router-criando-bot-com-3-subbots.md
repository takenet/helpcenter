...
![Importar fluxo BLiP](../../assets/practice/router/router-criando-bot-com-3-subbots-1.png)<br>
...
![Importar fluxo BLiP 2](../../assets/practice/router/router-criando-bot-com-3-subbots-2.png)<br>
...
![Importa fluxo BLiP 3](../../assets/practice/router/router-criando-bot-com-3-subbots-3.png)<br>
...
![Botão criar router BLiP](../../assets/practice/router/router-criando-bot-com-3-subbots-4.png)<br>

4.2 - Dê um nome para o bot router (por exemplo Filial Irlanda).  
4.3 - Publique o bot nos canais desejados

![Publicando bot em canais](../../assets/practice/router/router-criando-bot-com-3-subbots-5.png)<br>
...
![Serviçoes](../../assets/practice/router/router-criando-bot-com-3-subbots-6.png)<br>

5.3 - Adicione o subbot **Filial Brasil** definindo um nome para o serviço (por exemplo FilialBrasil)  

![Confirmar adição de serviço](../../assets/practice/router/router-criando-bot-com-3-subbots-7.png)<br>

5.4 - Adicione o subbot **Filial EUA** definindo um nome para o serviço (por exemplo FilialEUA)  

![Confirmar adição de serviço](../../assets/practice/router/router-criando-bot-com-3-subbots-8.png)<br>
...
![Testar bot router](../../assets/practice/router/router-criando-bot-com-3-subbots-9.png)<br>
...
![Testar bot router - informando a língua](../../assets/practice/router/router-criando-bot-com-3-subbots-10.png)<br>
...
![Condições de saída para router](../../assets/practice/router/router-criando-bot-com-3-subbots-11.png)<br>
...
![Redirecionando para serviços](../../assets/practice/router/router-criando-bot-com-3-subbots-12.png)<br>
...
![Mensagem para retornar ao bot principal](../../assets/practice/router/router-criando-bot-com-3-subbots-13.png)<br>

![Condição de saída para bot principal](../../assets/practice/router/router-criando-bot-com-3-subbots-14.png)<br>
...
![Condição de redirecionamento para bot principal](../../assets/practice/router/router-criando-bot-com-3-subbots-14.png)<br>
