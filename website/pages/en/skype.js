...
const data = { 
  "title":"Skype no BLiP",
  "subtitle":"Melhore o seu relacionamento com o cliente por meio do Skype!",
  "img":"/img/illustrations/skype-logo.svg",
  ...
  "cards": [
    {
      ...
      "type": "text",
      "url": "/docs/channels/skype/visao-geral-skype",
    ...
    },
    {
      ...
      "type": "text",
      "url": "/docs/channels/skype/funcionalidades-skype",
    ...
    },
    {
      ...
      "type": "text",
      "url": "/docs/channels/skype/tipos-conteudo-skype",
    ...
    },
    {
      ...
      "type": "text",
      "url": "/docs/channels/skype/como-interagir-skype",
        ...
        return(
            ...
            {/* Topo */}
              ...
              <div className="pages-content">
                ...
                <div className="info">
                  <p className="intro">O Skype é um software que permite a comunicação por mensagens de texto, voz e vídeo através da Internet. 
                    Está disponível em versão mobile, desktop e aplicação web, podendo ser acessado por smartphones, 
                    tablets, computadores, videogames, entre outros.</p>
                  <p className="intro">Esta categoria apresenta diferentes artigos sobre a integração do BLiP com o Skype. 
                    Nestes artigos você aprenderá como funciona este canal, quais seus principais benefícios e como criar sua 
                    primeira experiência integrando o seu contato inteligente ao Skype.</p>
