...
const data = {
  ...
  "here": "Microsoft Teams no BLiP",
  "cards": [
    {
      "title": "Visão geral do canal",
      "type": "text",
      "url": "/docs/channels/microsoft-teams/visao-geral-microsoft-teams",
    ...
    }, */
    {
      ...
      "type": "text",
      "url": "/docs/channels/microsoft-teams/funcionalidades-microsoft-teams",
    ...
    },
    {
      ...
      "type": "text",
      "url": "/docs/channels/microsoft-teams/tipos-conteudo-microsoft-teams",
    ...
    },
    {
      ...
      "type": "text",
      "url": "/docs/channels/microsoft-teams/publicando-bot-microsoft-teams",
    ...
    return (
      ...
      <div>
        ...
        <div className="pages-content">
          ...
          <div className="info">
            <p className="intro">
            O Microsoft Teams é uma plataforma desenvolvida pela Microsoft, com o intuito de unificar a comunicação
            e colaboração utilizando de bate-papo, videoconferências, armazenamento de arquivos e integração de aplicativos no local de trabalho.</p>
            <p className="intro">Esta categoria apresenta diferentes artigos sobre a integração do BLiP com o Microsoft Teams.
              Nestes artigos você aprenderá como funciona este canal, quais seus principais benefícios e
                    como criar sua primeira experiência integrando o seu contato inteligente ao Microsoft Teams.</p>
...
GoogleAssistant.title = 'Microsoft Teams no BLiP';
